...
extension Networking {
    ...
    public static func upload(url: NSURL, postData: NetworkingDataType, header: [String: String]? = nil, completionHandler:CompletionHandler = {_,_,_ in }) -> NSURLSessionUploadTask
    {
        ...
        return NSURLSession.sharedSession()
            .uploadTaskWithRequest(request, fromData: postData.toNSData(), completionHandler: completionHandler)
    }
	...
	//@warn_unused_result(message="Did you forget to call `resume` on the task?")
    public static let userLoginWithUserJSON = Networking.createTargetFunction(CONSTANT.URL.POST_LOGIN)
